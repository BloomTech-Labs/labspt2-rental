...
export const WelcomeMessage = (props) => {
    ...
    if(!props.user){
        ...
        welcome = (<FlexColumn justifyAround alignCenter style={{ width: '90%', marginTop: '2em', marginBottom: '3em' }}>
        <Header as='h1' style={{ fontSize: '3.5em', marginBottom: '8%' }}>Welcome {props.user.firstName}!</Header>
